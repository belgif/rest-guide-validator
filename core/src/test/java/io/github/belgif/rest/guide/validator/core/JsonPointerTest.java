...
public class JsonPointerTest {
    ...
    @Test
    public void buildPointerTest() {
        JsonPointer pointer = new JsonPointer("/paths/").add("/this/is/my/~path/").add("responses/");
        List<String> pointerSegtments = pointer.splitSegments();
    ...
    @Test
    public void addTest() {
        JsonPointer pointer = new JsonPointer("/first/second");
        ...
        JsonPointer secondPointer = new JsonPointer("/third/fourth");
