...
| outputFile | File | validationReport.json | Output file for JSON validation report. Default will be placed in rest-guide-validator.outputDir                   | rest-guide-validator.outputFile | 
